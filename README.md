...
Yukarıdaki örneği kullanarak **kendi ölçümlerinizle** bir tablo oluşturun (Aşağıda yeni bir tablo oluşturun ve yukarıdaki tabloya 3-4 tane kendi ölçümünü ekleyiniz.) Kullandığınız Google Sheet için [Grafik](https://docs.google.com/spreadsheets/d/1EobhE9QihxIh2NMbzRp_0x4L8ro9_eBIlKRXVMz5TuE/edit#gid=0) link verin (Google Sheet herkese açık erişimli olsun.) 
...
b) Hava sürtünmesini ihmal edersek, bu harakette ivme sabit midir?  **Hava sürtünmesi ortadan kalkarsa sadece masanın sürtünme kuvveti olur ve bu sürtünme kuvveti cisim harekete geçtikten sonra sabitlenir yani ivme sabitlenmiş olur.**

c) Video'daki cismin atılış hızı farklı olsaydı (diğer herşey aynı, kütle, yüzey, vb. Hava sürtünmesini ihmal edin), sizce formülde hangi terimler değişecekti? (a, b veya c) **Bence b ve c terimleri değişecekti.**
...
1) Kendi aldığınız verileri kullanarak **ortalama hız-zaman** grafiğini Google çiziniz. [Grafikler](https://docs.google.com/spreadsheets/d/1pgCRLE4Lq_dv40LWoqyPwVGmq0wWPCtlxv1H3JzRT5E/edit#gid=0) link veriniz.
...
3) İvme'yi ne buldunuz? **-2,84** Bu ivme değerini kullanarak 1kg'lık cisim ile yüzey arasındaki kinetik sürtünme katsayısını bulunuz. 
**F = m * a = 1 * -2,84 = -2,84**

# Bölüm 3 (Hala Beni Öldürmeyi Düşünmüyorsan)
1) Bu deneyde ölçüm hatalarım var. Zamandaki ölçüm hatam sizce kaç ms (mili saniye) nedir? Konumdaki ölçüm hatam sizce kaç cm'dir? **40 ms ve 1 cm olabilir.**
